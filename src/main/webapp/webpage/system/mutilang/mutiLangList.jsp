...
<t:base type="jquery,easyui,tools"/>
  <t:datagrid name="mutiLangList" title="lang.maintain" actionUrl="mutiLangController.do?datagrid" idField="id" fit="true" queryMode="group" sortName="id" sortOrder="desc">
   ...
   <t:dgCol title="common.languagekey" field="langKey" query="true" width="75" align="center" ></t:dgCol>
   <t:dgCol title="common.content"  width="75" align="center" field="langContext" query="true" ></t:dgCol>
   <t:dgCol title="common.language"  width="55" align="center" field="langCode" ></t:dgCol>
   ...
   <t:dgCol title="common.operation" field="opt" width="55" align="center" ></t:dgCol>
