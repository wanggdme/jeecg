...
<div region="center" style="padding:0px;border:0px">
    <t:datagrid name="iconList" title="icon.list" actionUrl="iconController.do?datagrid" fit="true" fitColumns="true" idField="id">
        ...
        <t:dgCol title="common.icon.name"  width="50" align="center" query="true" field="iconName"></t:dgCol>
        <t:dgCol title="common.icon.style"  width="50" align="center" field="iconClas"></t:dgCol>
        <t:dgCol title="common.icon.type"  width="50" align="center" field="iconType" replace="system.icon_1,menu.icon_2,desktop.icon_3"></t:dgCol>
        <t:dgCol title="common.icon"  width="50" align="center" field="iconPath" image="true" style="width:20px; height:20px;"></t:dgCol>
        <t:dgCol title="common.icon.type"  width="50" align="center" field="extend"></t:dgCol>
        <t:dgCol title="common.operation"  width="50" align="center" field="opt"></t:dgCol>
